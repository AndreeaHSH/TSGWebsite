...
namespace TSGwebsite.Migrations
{
    ...
    [Migration("20250710195205_FixStaticSeed")]
            ...
            modelBuilder.Entity("TSGwebsite.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 7, 10, 19, 52, 4, 704, DateTimeKind.Utc).AddTicks(6081),
                            Email = "admin@tsg.com",
                            FirstName = "TSG",
                            IsActive = true,
                            LastName = "Administrator",
                            PasswordHash = "$2a$11$eMNBk/B02AuOb2FhZq6sM.ip7Ffs/h3wGar39d.Yw7zY9YbtKlywq",
                            Role = 0,
                            Username = "admin"
                        });
                });
